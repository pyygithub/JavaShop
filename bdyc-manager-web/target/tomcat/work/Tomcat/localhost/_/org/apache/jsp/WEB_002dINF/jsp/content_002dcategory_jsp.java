 ...
 * Generated at: 2017-05-25 09:36:58 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t\t// 新增节点\r\n");
      out.write("        \t\t$.post(\"/content/category/add\",{parentId:node.parentId,name:node.text},function(data){\r\n");
      ...
      out.write("            \t\t\t});\r\n");
      out.write("        \t\t\t}else{\r\n");
      out.write("        \t\t\t\t$.messager.alert(\"提示\",\"创建节点失败\",\"error\");\r\n");
      out.write("        \t\t\t}\r\n");
      out.write("        \t\t});\r\n");
      out.write("        \t}else{//重命名\r\n");
      ...
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t// 删除节点\r\n");
      out.write("        \t\t$.post(\"/content/category/del\",{id:node.id},function(data){\r\n");
      out.write("        \t\t\tif(data.status == 200){\r\n");
      out.write("        \t\t\t\tif(data.msg == \"fail\"){\r\n");
      out.write("        \t\t\t\t\t$.messager.alert(\"提示\",\"该节点下存在子节点不允许删除！\",\"warning\");\r\n");
      out.write("        \t\t\t\t}else{\r\n");
      out.write("        \t\t\t\t\ttree.tree(\"remove\",node.target);\r\n");
      out.write("        \t\t\t\t}\r\n");
      out.write("        \t\t\t}else{\r\n");
      out.write("        \t\t\t\t$.messager.alert(\"提示\",\"删除节点失败\",\"error\");\r\n");
      out.write("        \t\t\t}\r\n");
      out.write("        \t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");

 ...
 * Generated at: 2017-05-25 09:36:41 UTC
...
public final class item_002dparam_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<ul>\r\n");
      out.write("\t\t\t<li>\r\n");
      out.write("\t\t\t\t<input class=\"easyui-textbox\" style=\"width: 150px;\" name=\"group\"/>&nbsp;<a href=\"javascript:void(0)\" class=\"easyui-linkbutton addParam\"  title=\"添加参数\" data-options=\"plain:true,iconCls:'icon-add'\"></a>&nbsp;<a href=\"javascript:void(0)\" class=\"easyui-linkbutton delParam\" title=\"删除\" data-options=\"plain:true,iconCls:'icon-cancel'\"></a>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t\t<li>\r\n");
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\tJavaShop.initItemCat({\r\n");
      out.write("\t\t\t fun:function(node){\r\n");
      out.write("\t\t\t \t$(\".addGroupTr\").hide().find(\".param\").remove();\r\n");
      out.write("\t\t\t  \t//判断选择的目录是否已经添加过规格:根据categoryid查询\r\n");
      out.write("\t\t\t  \t$.getJSON(\"/item/category/param/query/\" + node.id,function(resp){\r\n");
      out.write("\t\t\t\t  if(resp.status == 200 && resp.data){\r\n");
      out.write("\t\t\t\t\t  $.messager.alert(\"提示\", \"该类目已经添加规则参数，请选择其它类目设置。\", undefined, function(){\r\n");
      out.write("\t\t\t\t\t\t $(\"#itemParamAddTable .selectItemCat\").click();\r\n");
      out.write("\t\t\t\t\t  });\r\n");
      out.write("\t\t\t\t\t  return ;\r\n");
      out.write("\t\t\t\t  }\r\n");
      out.write("\t\t\t\t  //显示添加规则分组按钮\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\tvar url = \"/item/category/param/add/\"+$(\"#itemParamAddTable [name=cid]\").val();\r\n");
      out.write("\t\t\t$.post(url,{\"paramData\":JSON.stringify(params)},function(data){\r\n");
      out.write("\t\t\t\tif(data.status == 200){\r\n");
      out.write("\t\t\t\t\t$.messager.alert('提示','新增商品规格参数成功!',undefined,function(){\r\n");
      out.write("\t\t\t\t\t\t$(\".panel-tool-close\").click();\r\n");

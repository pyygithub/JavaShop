...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false">
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center'" >
            <table class="easyui-datagrid" id="contentList" data-options="fit:true,border:false,toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'/content/list',queryParams:{categoryId:0}">
		    <thead>
		        <tr>
...
var contentListToolbar = [{
    ...
    iconCls:'icon-edit',
    handler:function(){
    	var ids = JavaShop.getSelectionsIds("#contentList");
    	if(ids.length == 0){
